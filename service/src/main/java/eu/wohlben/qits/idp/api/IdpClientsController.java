...
public class IdpClientsController {
  ...
  public record CommissionRequest(
    ...
    /** The two-field form every caller predating per-context scoping sends. */
    public CommissionRequest(String contextKind, String contextId) {
      this(contextKind, contextId, null);
    }
  }
